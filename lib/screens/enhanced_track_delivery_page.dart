    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<DeliveryModel>>(
        ...
        builder: (context, snapshot) {
          print(
            'Enhanced Track Delivery - StreamBuilder: SwapId: ${widget.swapId}, Connection State: ${snapshot.connectionState}, Has Data: ${snapshot.hasData}, Data Length: ${snapshot.data?.length ?? 0}',
          );
          ...
          print(
            'Enhanced Track Delivery - Found ${deliveries.length} deliveries for swap',
          );
